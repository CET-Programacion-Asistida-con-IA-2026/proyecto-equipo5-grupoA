...
Por otro lado, los métodos de enseñanza tradicionales muchas veces no logran enganchar ni motivar a los alumnos. Por eso, vemos la necesidad de sumar herramientas digitales que hagan el aprendizaje más dinámico, interactivo y atractivo para ellos.
...
> Este objetivo busca garantizar una educación inclusiva, equitativa y de calidad, promoviendo oportunidades de aprendizaje para todas las personas.
> 
> **EduZOO** contribuye directamente a esta meta mediante el desarrollo de una plataforma web que favorece el aprendizaje de la lectura y la escritura a través de experiencias lúdicas, dinámicas e interactivas.
